      ...
      <div className="bg-light mt-3 page-container">
        <div className='container-lg' >
          <div className='text-center'>
            <h1 className="fs-2 fw-light text-center">View some of our previous projects</h1>
          </div>
            <div className='row my-5 align-items-center justify-content-center justify-content-around'>
              ...
              <div className="card">
                <div className="card-body text-center py-4">
                  <h4 className="card-title" style={{color: 'black'}}>Tournesol</h4>
                    <img src="../assets/card-1.png" class="card-img-top" alt="A brand logo image for the French restaurant tournesol. A website project developed by unique you."/>
              ...
              <div className="card">
                <div className="card-body text-center py-4">
                  <h4 className="card-title" style={{color: 'black'}}>Electric City</h4>
                    <img src="../assets/card-2.png" class="card-img-top" alt="A brand logo image for a retail store. A website project developed by unique you."/>
              ...
              <div className="card">
                <div className="card-body text-center py-4">
                  ...
                  <img src="../assets/card-3.png" class="card-img-top" alt="A brand logo image for a digital wallet platform titled Checkmate"/>
